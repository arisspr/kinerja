                                ...
                                <div class="card-body">                                        
                                    <%
                                        ...
                                        if (ss) {
                                            ...
                                            if (first.length() > 1) {
                                                wherecond1 = "b.nik_employee ='" + first + "'";
                                            } else {
                                            ...
                                            String Report = "Select a.nik, a.nama, sum(b.durasi) as counter, sum (b.durasi) filter (where b.approve = 'Disetujui' and EXTRACT(MONTH FROM b.tanggal_aktivitas) ='" + last + "') as approve, "
                                                    ...
                                                    + "WHERE " + wherecond1 + " and a.level ='Employee' group by a.nik, a.nama";
...
//                                                                  out.print(counter); 
                                                        %></td>
                                                    <td><%
                                                        String count =report.getString("notapprove");                                                        
                                                        if (count == null) {
                                                            out.print("0 %");
                                                        } else {
...
//                                                                   capaian = Double.parseDouble(new DecimalFormat("##.##").format(capaian));
                                                    ...
                                                    <td>
                                                        <a href="detailscapaian?id=<%= DatatypeConverter.printBase64Binary(report.getString("nik").getBytes())%>&month=<%= DatatypeConverter.printBase64Binary(last.getBytes())%>"class="btn btn-small"><i class="fas fa-edit"></i> Details</a>
                                                    </td>
                                                </tr>
                                                <% } %>
                                            </tbody>
