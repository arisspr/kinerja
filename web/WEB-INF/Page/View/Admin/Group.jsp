                                ...
                                <div class="card shadow mb-4 NH">
                                    <div class="card-header py-3">
                                        <span class="float-left"> 
                                            <a href="addgroup" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                                            ...
                                            <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                                                ...
                                                <tbody id="show_data">
                                                    <%
                                                        ...
                                                        String group = "Select *, t.nama_aktifitas from master.group as g "
                                                                + "join master.tupoksi as t on t.kode = g.tupoksi "
                                                                + "";
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><%= mygroup.getString("group_name")%></td>
                                                        <td><%= mygroup.getString("nama_aktifitas")%></td>
                                                        <td width="250">
